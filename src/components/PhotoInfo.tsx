...
export function PhotoInfo({ photo, onClose, onSave, onReplace }: PhotoInfoProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-4 right-4 z-50 flex items-center gap-3 p-1">
          {/* Replace button - allow re-uploading */}
          {onReplace && (
            <button
              onClick={() => {
                onClose();
              ...
              className="text-white hover:text-purple-200 transition-colors bg-black/50 hover:bg-black/70 rounded-full w-10 h-10 flex items-center justify-center backdrop-blur-sm"
              style={{ 
                fontWeight: 400,
          ...
          {onSave && !isEditing && (
            <button
              ...
              className="text-white hover:text-purple-200 transition-colors bg-black/50 hover:bg-black/70 rounded-lg px-4 py-2 backdrop-blur-sm"
              style={{ 
                fontSize: '1rem', 
                fontWeight: 400,
                fontFamily: "'Cormorant Garamond', serif"
